...
@router.post("/publish_task/init_upload_finam_dividends")
async def upload_finam_dividends(reupload:bool=False):
    return await common_task('init_upload_finam_dividends',{'reupload':reupload})
